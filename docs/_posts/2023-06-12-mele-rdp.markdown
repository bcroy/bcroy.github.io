...
Hmm... a little stuck now... but what I am trying to do is identify, in general, that there exists a $$Y_1$$, $$Y_2$$ and covariate offset vector $$a$$ such that $$B$$ can be expressed as inner products of $$Y_1$$, $$Y_1 + a$$, $$Y_2$$ and $$Y_2 + a$$.
